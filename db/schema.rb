...
ActiveRecord::Schema.define(version: 2023_07_29_085426) do
  ...
  create_table "productes", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_productes_on_user_id"
  end
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "name_chinese_characters", null: false
    t.string "first_name_chinese_characters", null: false
  ...
  add_foreign_key "productes", "users"
end
